...
then # Fail
     echo "An error occured. Error: kvm installation failed."
     exit 1
fi
...
if [ $? -ne 0 ] # Did the command work?
then # Fail
     echo "An error occured. Error: lvm installation failed."
     exit 1
fi

#sudo apt-get -y install python-paramiko python-affinity qemu-utils
sudo apt-get -y install python-paramiko qemu-utils

if [ $? -ne 0 ] # Did the command work?
then # Fail
     echo "An error occured. Error: qemu-utils installation failed."
     exit 1
fi
...
if [ $? -ne 0 ] # Did the command work?
then # Fail
     echo "An error occured. Error: Python tools and libraries installation failed."
     exit 1
fi
...
if [ $? -ne 0 ] # Did the command work?
then # Fail
     echo "An error occured. Error: Haskell installation failed."
     exit 1
fi
...
if [ $? -ne 0 ] # Did the command work?
then # Fail
     echo "An error occured. Error: libghc files installation failed."
     exit 1
fi
...
if [ $? -ne 0 ] # Did the command work?
then # Fail
     echo "An error occured. Error: DRBD installation failed."
     exit 1
fi
