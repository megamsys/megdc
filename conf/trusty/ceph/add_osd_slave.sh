...
sshpass -p "cibadmin" scp -o StrictHostKeyChecking=no /home/cibadmin/.ssh/id_rsa.pub cibadmin@$1:/home/cibadmin/.ssh/authorized_keys


REMHOST='ssh cibadmin@$1 hostname'
echo $REMHOST
